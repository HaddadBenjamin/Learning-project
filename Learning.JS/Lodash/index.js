...
_.take([1, 2, 3], 2) // U [1, 2] récupère n éléments (voir aussi takeWhile & takeRightWhile)
...
_.findIndex(users, ['active', false]) // 0 voir aussi findLastIndex / lastIndexOf
...
_.drop([1, 2, 3], 2) // U [3]
_.dropRight([1, 2, 3]) // U [1, 2] retire 0 à n éléments à partir de la fin (voir aussi dropWhile & dropRightWhile)
_.without([2, 1, 2, 3], 1, 2) // [3] U Supprime plusieurs valeurs d'un tableau
...
// Calcul d'un tableau :
_.union([2], [1, 2]) // U [2, 1] combine plusieurs tableaux et supprime les doublons
