...
const getTodosEpic : TodoEpic = (action$, state$, { apis : { todo : api }}) => action$.pipe(
...
const createTodoEpic : TodoEpic = (action$, state$, { apis : { todo : api }, repositories : { todo : repository }}) => action$.pipe(
...
const patchTodoTitleEpic : TodoEpic = (action$, state$, { apis : { todo : api }}) => action$.pipe(
...
const patchTodoCompletedEpic : TodoEpic = (action$, state$, { apis : { todo : api }}) => action$.pipe(
...
const deleteTodoEpic : TodoEpic = (action$, state$, { apis : { todo : api }}) => action$.pipe(
